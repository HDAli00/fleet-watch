...
def test_publish_readings_success(kinesis_client: object) -> None:
    ...
    with patch.dict(os.environ, {"WEATHER_STREAM_NAME": "solar-weather-stream", "AWS_DEFAULT_REGION": "eu-west-1"}):
        published = publish_readings(SAMPLE_READINGS, stream_name="solar-weather-stream")
